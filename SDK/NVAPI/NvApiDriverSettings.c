...
SettingDWORDNameString mapSettingDWORD[TOTAL_DWORD_SETTING_NUM] = 
{
    ...
    {SHIM_RENDERING_OPTIONS_ID,            SHIM_RENDERING_OPTIONS_STRING,            17, (NvU32 *)g_valuesSHIM_RENDERING_OPTIONS,  SHIM_RENDERING_OPTIONS_DEFAULT_RENDERING_MODE},
    ...
    {PRERENDERLIMIT_ID,                    PRERENDERLIMIT_STRING,                     2, (NvU32 *)g_valuesPRERENDERLIMIT,          0x00000003},
    ...
    {VSYNCMODE_ID,                         VSYNCMODE_STRING,                          3, (NvU32 *)g_valuesVSYNCMODE,               VSYNCMODE_PASSIVE},
};

...
public:
	...
	struct	RayResultCallback
	{
		...
		{
			int iArbValue = 0;
			if ( m_collisionObject!=NULL ) iArbValue = (int)m_collisionObject->getUserPointer();
			return iArbValue;
		}
	...
	struct	ClosestConvexResultCallback : public ConvexResultCallback
	{
		...
		int	GetArbValue()
		{
			int iCollisionArbValue = 0;
			if ( m_hitCollisionObject!=NULL ) iCollisionArbValue = (int)m_hitCollisionObject->getUserPointer();
			return iCollisionArbValue;
		}		

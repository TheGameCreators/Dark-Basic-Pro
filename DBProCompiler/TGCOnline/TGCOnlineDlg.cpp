...
//			PostQuitMessage(0);
		...
		case IDC_BUY :		// Link
		{
			...
			strcat ( g_pFeedbackAreaString, "66,67,68 = Box2DPlugin\r\n");
			strcat ( g_pFeedbackAreaString, "69,70,71 = BlitzTerrain\r\n");
			strcat ( g_pFeedbackAreaString, "72,73,74 = DarkImposters\r\n");

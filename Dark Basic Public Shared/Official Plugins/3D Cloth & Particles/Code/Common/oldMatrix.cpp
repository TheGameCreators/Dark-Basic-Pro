...
void Matrix::setPos(const Vector3& v)
{
...
const Vector3 Matrix::unitX() const
{
	return Vector3(e00,e01,e02);
}
const Vector3 Matrix::unitY() const
{
	return Vector3(e10,e11,e12);
}
const Vector3 Matrix::unitZ() const 
{
	return Vector3(e20,e21,e22);
}
const Vector3 Matrix::pos() const 
{

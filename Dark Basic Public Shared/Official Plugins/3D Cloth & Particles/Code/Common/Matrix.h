#ifndef __ENGINEMATRIX_HEADER
#define __ENGINEMATRIX_HEADER

#include "memory.h"
#include "Vector.h"

#define TORADIANS(x) (x)*0.01745329252f
#define TODEGREES(x) (x)*57.29578f
...
class Matrix
{
	...
	public:
		...
		//Constructors;
		Matrix():e00(1.0f),e01(0),e02(0),e03(0),
				e10(0),e11(1.0f),e12(0),e13(0),
				e20(0),e21(0),e22(1.0f),e23(0),
				e30(0),e31(0),e32(0),e33(1.0f){}
		...
		void Set3x3(const Vector3& v0,const Vector3& v1,const Vector3& v2);
		...
		const Vector3 unitX() const {return Vector3(e00,e01,e02);}
		const Vector3 unitY() const {return Vector3(e10,e11,e12);}
		const Vector3 unitZ() const {return Vector3(e20,e21,e22);}
		const Vector3 pos() const {return Vector3(e30,e31,e32);}
		...
		void setPos(const Vector3& v) {e30=v.x;e31=v.y,e32=v.z;}

		void Move(float i, float j, float k) {e30+=i;e31+=j,e32+=k;}
		void Move(const Vector3& v);		

		void set3x3ToQuat(const Quat& q);
		...
		void makeRotationAxisAngle(const Vector3& axis, float angle);
		...
		void make3x3RotationAxisAngle(const Vector3& axis, float angle);

...
#ifndef	NXU_TINYXML_INCLUDED
#define	NXU_TINYXML_INCLUDED
...
class	TiXmlBase
{
	 ...
	 public:
			 ...
			 */
			virtual	void Print(NXU_FILE	*cfile,	int	depth)const	=	0;
			...
			enum
			{
						TIXML_NO_ERROR = 0,	TIXML_ERROR, TIXML_ERROR_OPENING_NXU_FILE, TIXML_ERROR_OUT_OF_MEMORY,	TIXML_ERROR_PARSING_ELEMENT, TIXML_ERROR_FAILED_TO_READ_ELEMENT_NAME,	TIXML_ERROR_READING_ELEMENT_VALUE, TIXML_ERROR_READING_ATTRIBUTES, TIXML_ERROR_PARSING_EMPTY,	TIXML_ERROR_READING_END_TAG, TIXML_ERROR_PARSING_UNKNOWN,	TIXML_ERROR_PARSING_COMMENT, TIXML_ERROR_PARSING_DECLARATION,	TIXML_ERROR_DOCUMENT_EMPTY,	TIXML_ERROR_EMBEDDED_NULL, TIXML_ERROR_PARSING_CDATA,
...
class	TiXmlAttribute:	public TiXmlBase
{
	 ...
	 public:
			...
			// Prints	this Attribute to	a	NXU_FILE stream.
			virtual	void Print(NXU_FILE	*cfile,	int	depth)const;
...
class	TiXmlElement:	public TiXmlNode
{
	 public:
			...
			// Print the Element to	a	NXU_FILE stream.
			virtual	void Print(NXU_FILE	*cfile,	int	depth)const;
...
class	TiXmlDocument: public	TiXmlNode
{
	 public:
			...
			bool LoadFile(const	char *filename,void *mem=0,int len=0,TiXmlEncoding	encoding = TIXML_DEFAULT_ENCODING);
			 ...
			 */
			bool LoadFile(NXU_FILE *,	TiXmlEncoding	encoding = TIXML_DEFAULT_ENCODING);
			///	Save a file	using	the	given	NXU_FILE*. Returns true	if successful.
			bool SaveFile(NXU_FILE*)const;
			...
			virtual	void Print(NXU_FILE	*cfile,	int	depth	=	0)const;
			// [internal use]

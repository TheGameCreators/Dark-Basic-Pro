...
class CSoundManager
{
	// MIKE - 090104 - changed this section from protected to public
public:
    LPDIRECTSOUND8 m_pDS;

	// mike - 010904 - 5.7 - variable to store existance of sound card
	bool	m_bSoundCardExists;
...
public:
	...
	DWORD GetBufferSize ( void ) { return m_dwDSBufferSize; }
    LPSTR GetBufferData( void ) { return m_pCopyOfBuffer; }

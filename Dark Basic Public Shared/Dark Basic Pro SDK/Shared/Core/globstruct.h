...
enum {
	...
	//DB3_SIN_TABLE_RESOLUTION=2048
	//DB3_SIN_TABLE_RESOLUTION=4096
	//DB3_SIN_TABLE_RESOLUTION=8192
	//DB3_SIN_TABLE_RESOLUTION=16384
	//DB3_SIN_TABLE_RESOLUTION=32768
	//DB3_SIN_TABLE_RESOLUTION=65536
	//DB3_SIN_TABLE_RESOLUTION=131072
	DB3_SIN_TABLE_RESOLUTION=262144
	//DB3_SIN_TABLE_RESOLUTION=524144
	//DB3_SIN_TABLE_RESOLUTION=1050576
	//DB3_SIN_TABLE_RESOLUTION=2101152
};
...
struct GlobStruct
{
	...
	// aaron - 20120813 - sine table
	double						f64SinTable[DB3_SIN_TABLE_RESOLUTION];
};
...
//
//	aaron - 20120811 - Add utility functions to make life a bit easier
//
typedef DWORD dbReturnFloat_t;
__forceinline dbReturnFloat_t dbReturnFloat(float x) {
	union { float f; dbReturnFloat_t i; } v;

	v.f = x;
	return v.i;
}

inline char *dbReturnString(char *oldstr, const char *newstr) {
	size_t l;
	char *p;

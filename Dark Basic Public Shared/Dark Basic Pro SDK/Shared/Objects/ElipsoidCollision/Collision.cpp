...
BOOL Collision::World ( D3DXVECTOR3 starto, D3DXVECTOR3 endo, D3DXVECTOR3 eRadius, float fScale )
{
	...
	if ( trace->foundCollision )
	{
		...
		D3DXVECTOR3 finalPos = D3DXVECTOR3 ( trace->finalPosition[0], trace->finalPosition[1], trace->finalPosition[2] );
		start.x *= eRadius.x;
		start.y *= eRadius.y;
		start.z *= eRadius.z;
...
/* OLD COLLISION SYSTEM FOR UNIVERSE DERIVED FROM BSP APPROACH
